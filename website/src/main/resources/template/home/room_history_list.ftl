            ...
            <div class="account-top">
                ...
                <div class="account-text">
                    <h3 class="colord4 font20"> ${userInfoDTO.userPhone? substring(0,3)}****${userInfoDTO.userPhone ? substring(7,11)}
                        ，欢迎您回家！&nbsp;<small class="color48 font14">
                            【<a  href="${basePath}/login/out" class="color48 font14">退出账户</a>】</small>
                    </h3>
                    <div class="flex-between">
                        <h5 class="color27 font18"><b>${checkInHistoryDTO.roomName?replace('>','-')}</b>
                            <small class="colord4 font14">&nbsp;【<span class="colord4 font14">已退房</span>】</small>
                        </h5>
                        <p class="color99 font14 text-right">退房日期：${checkInHistoryDTO.checkOutTime?string("yyyy.MM.dd")}</p>
                    </div>
                    <p class="font14 color99">欢迎您再次入住，入住乐璟，乐享生活</p>
                </div>
            </div>
            <div class="part1">
                              ...
                              <li class="relative">
                                  <a href="${basePath}/house/${house.id}" target="_blank">
                                      ...
                                      <div class="room-text flex-between color27">
                                          ...
                                          <span class="w-50 text-right font12 color66">【${house.houseStyle}】${house.bedNumStr}</span>
                                      </div>
